...
class CreateCargowiseDataImportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cargowise_data_imports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('cargowise_data_imports');
    }
}
